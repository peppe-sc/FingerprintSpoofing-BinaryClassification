...
def lab11(DTR,LTR,DVAL,LVAL, pT = 0.1):
    ...
    plt.plot(logOdds, minDCF, color='C0', linestyle='--', label = 'LogReg - minDCF')
    plt.plot(logOdds, actDCF, color='C0', linestyle='-', label = 'LogReg - actDCF')
    logOdds, actDCF, minDCF = bayesPlot(calibrated_scores_SVM, labelsSVM)
    plt.plot(logOdds, minDCF, color='C1', linestyle='--', label = 'SVM - minDCF')
    plt.plot(logOdds, actDCF, color='C1', linestyle='-', label = 'SVM - actDCF')
    logOdds, actDCF, minDCF = bayesPlot(calibrated_scores_GMM, labelsGMM)
    plt.plot(logOdds, minDCF, color='C3', linestyle='--', label = 'GMM - minDCF')
    plt.plot(logOdds, actDCF, color='C3', linestyle='-', label = 'GMM - actDCF')      
    
    logOdds, actDCF, minDCF = bayesPlot(fusedScores, fusedLabels)
    plt.plot(logOdds, minDCF, color='C2', linestyle='--', label = 'Fusion - KFold - minDCF(0.1)')
    plt.plot(logOdds, actDCF, color='C2', linestyle='-', label = 'Fusion - KFold - actDCF(0.1)')
